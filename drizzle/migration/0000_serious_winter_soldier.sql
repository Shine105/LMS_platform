...
ALTER TABLE "purchases" ADD CONSTRAINT "purchases_productId_courses_id_fk" FOREIGN KEY ("productId") REFERENCES "public"."courses"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
